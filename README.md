...
## Installation
```
$ git clone https://github.com/slizyoke/slizyoke.git
$ cd slizyoke
```

## Usage
```
$ python3 slizyoke.py -u [username] -w [wordlist] -x [xmlrpc_intf] -t [threads_number] -c [chunks_size] -v [verbose] -h [help]
